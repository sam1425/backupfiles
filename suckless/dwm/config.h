...
static const Key        keys[] = {
	...
	{0,                                XF86XK_AudioPlay,                                spawn,                        SHCMD("playerctl play-pause; kill -41 $(pidof dwmblocks)")},
	{0,                                XF86XK_AudioNext,                                spawn,                        SHCMD("playerctl next; kill -41 $(pidof dwmblocks)")},
	{0,                                XF86XK_AudioPrev,                                spawn,                        SHCMD("playerctl previous; kill -41 $(pidof dwmblocks)")},
