...
hb_feature_t features[] = {
	{ .tag = HB_TAG('l','i','g','a'), .value = 0, .start = HB_FEATURE_GLOBAL_START, .end = HB_FEATURE_GLOBAL_END },
	{ .tag = HB_TAG('c','a','l','t'), .value = 0, .start = HB_FEATURE_GLOBAL_START, .end = HB_FEATURE_GLOBAL_END },
	{ .tag = HB_TAG('d','l','i','g'), .value = 0, .start = HB_FEATURE_GLOBAL_START, .end = HB_FEATURE_GLOBAL_END },
	{ .tag = HB_TAG('k','e','r','n'), .value = 0, .start = HB_FEATURE_GLOBAL_START, .end = HB_FEATURE_GLOBAL_END }
};
void
hbunloadfonts()
{
